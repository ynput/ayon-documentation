            ...
            <div className="card">
                ...
                <div className={clsx("card__footer")}>
                    <div class="button-group button-group--block">
                        {demo != "" && (
                            <a href={demo} class="button button--secondary">
                                Demo
                            </a>
                        )}
                        {docs != "" && (
...
function Home() {
    ...
    return (
        ...
        >
            <section className={clsx("section lightBackground")}>
                <div className={clsx(styles.card_container, "container")}>
                    <h2>Key Features</h2>
            ...
            <section className={clsx("section darkBackground")}>
                <div className={clsx(styles.card_container, "container")}>
            ...
            <section className={clsx("section lightBackground")}>
                <div className={clsx(styles.card_container, "container")}>
                    <h2 id="maya">
                        <a href="docs/artist_hosts_blender">Autodesk Maya</a>
                    </h2>
            ...
            <section className={clsx("section lightBackground")}>
                <div className={clsx(styles.card_container, "container")}>
                    <h2 id="hiero">
                        <a href="docs/artist_hosts_blender">
            ...
            <section className={clsx("section darkBackground")}>
                <div className={clsx(styles.card_container, "container")}>
                    <h2>
                        <a href="docs/artist_hosts_photoshop">After Effects</a>
                    </h2>
            ...
            <section className={clsx("section lightBackground")}>
                <div className={clsx(styles.card_container, "container")}>
                    <h2>
                        <a href="docs/artist_hosts_photoshop">Photoshop</a>
                    </h2>
            ...
            <section className={clsx("section darkBackground")}>
                <div className={clsx(styles.card_container, "container")}>
                    <h2>
                        <a href="docs/artist_hosts_harmony">Harmony</a>
                    </h2>
            ...
            <section className={clsx("section lightBackground")}>
                <div className={clsx(styles.card_container, "container")}>
                    <h2>
                        <a href="docs/artist_hosts_tvpaint">TV Paint</a>
                    </h2>
            ...
            <section className={clsx("section lightBackground")}>
                <div className={clsx(styles.card_container, "container")}>
                    <h2>
                        <a href="docs/artist_hosts_blender">Blender</a>
                    </h2>
