...
The can quickly view a Reviewable by using the Web Viewer. To open the viewer:
...
:::tip
We recommend using the the two main shortcuts `A - previous version` and `D - next version` to quickly flick back and forth between versions.
:::
