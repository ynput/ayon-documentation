...
Avalon/Pype integration needs [Avalon Unreal Integration Plugin](https://github.com/ynput/avalon-unreal-integration). Use `AVALON_UNREAL_PLUGIN` environment variable to point to it. When new
...
* *Avalon Unreal Integration plugin* ([sources are on GitHub](https://github.com/ynput/avalon-unreal-integration))
