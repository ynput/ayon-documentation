...
![Failed Model Validator](assets/maya/artist/maya-model_publish_error.jpg)
...
multiple assets maya/artist/loaded in scene. Click on one of those button now.

You should now see all assets maya/artist/and their products loaded in scene, and on right side
...
![Maya - Point Cache Example](assets/maya/artist/maya-pointcache_setup.png)
...
![Maya - Render Publish errors](assets/maya/artist/maya-render_publish_detail1.jpg)
